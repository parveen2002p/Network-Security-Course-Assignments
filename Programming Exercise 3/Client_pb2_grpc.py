...
class ClientCommunicationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReceiveMessage = channel.unary_unary(
                ...
                response_deserializer=Client__pb2.Acknowledgement.FromString,
                )
...
def add_ClientCommunicationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReceiveMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=Client__pb2.Acknowledgement.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ClientCommunication', rpc_method_handlers)
...
class ClientCommunication(object):
    ...
    def ReceiveMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ClientCommunication/ReceiveMessage',
            Client__pb2.Message.SerializeToString,
            Client__pb2.Acknowledgement.FromString,
